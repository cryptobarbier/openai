...
gecko='C:\\Users\\PC\\Downloads\\phantomjs-2.1.1-windows\\phantomjs-2.1.1-windows\\bin\\phantomjs'
    
    
    
binary = webdriver.firefox.firefox_binary.FirefoxBinary('C:\Program Files (x86)\Mozilla Firefox\Firefox.exe')
#driver = webdriver.Firefox(firefox_binary=binary, executable_path=gecko+'.exe')
driver = webdriver.PhantomJS(executable_path=gecko)
    
firefox_profile = webdriver.FirefoxProfile()
#firefox_profile.add_extension("/home/.../.mozilla/firefox/zrdb9ki8.default/extensions/{d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d}.xpi") # for adblockplus
firefox_profile.set_preference("extensions.adblockplus.currentVersion", "2.8.2")
